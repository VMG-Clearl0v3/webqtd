...
*/}     
     <div className="flex max-w-[1000px] mx-auto items-center justify-center gap-4 ">
          ...
          <Image src ="/image/savings_14667460.png" alt ="icon" width={50} height={50}/>
           ...
           <p className="cont_nd"> Gửi tiết kiệm tại quầy, online lãi suất hấp dẫn</p>
          ...
          <button className={"${inter.className} px-6 py-2 bg-white text-[#01274B] rounded-lg shadow-md transform transition-all duration-300 hover:bg-[#01274B] hover:text-white hover:scale-105 hover:shadow-xl" }>
        ...
        <div className="bg-white h-60 w-55 flex flex-col items-center text-center p-4 rounded-sm">
           ...
           <p className="cont_nd"> Vay tiêu dùng, sản xuất kinh doanh, cầm cố sổ tiết kiệm nhanh chóng</p>
          <button className={"${inter.className} px-6 py-2 bg-white text-[#01274B] rounded-lg shadow-md transform transition-all duration-300 hover:bg-[#01274B] hover:text-white hover:scale-105 hover:shadow-xl" }>
            <a href="#">Xem chi tiết</a>
          </button>
        </div>
        <div className="bg-white h-60 w-55 flex flex-col items-center text-center p-4 rounded-sm">
           ...
           <p className="cont_nd"> Tham gia thành viên, mở tài khoản nhận nhiều ưu đãi</p>
          <button className={"${inter.className} px-6 py-2 bg-white text-[#01274B] rounded-lg shadow-md transform transition-all duration-300 hover:bg-[#01274B] hover:text-white hover:scale-105 hover:shadow-xl" }>
            <a href="#">Xem chi tiết</a>
          </button>
        </div>
          <div className="bg-white h-60 w-55 flex flex-col items-center text-center p-4 rounded-sm">
           ...
           <p className="cont_nd"> Chuyển tiền trong nước an toàn, tiện lợi</p>
          <button className={"${inter.className} px-6 py-2 bg-white text-[#01274B] rounded-lg shadow-md transform transition-all duration-300 hover:bg-[#01274B] hover:text-white hover:scale-105 hover:shadow-xl" }>
            <a href="#">Xem chi tiết</a>
          </button>
          </div>
        </div>
      <div className="mx-auto max-w-full pb-8 pt-12 xl:container">
      ...
      <div className="mx-auto max-w-full pb-8 pt-12 xl:container">
        <div className="flex flex-col">
          ...
          <div className="right-0 my-2 md:absolute max-xl:w-full md:block"><a className="max-xl:justify-end flexbg-transparent flex border-none px-0 items-center gap-1 text-primary-content text-blue-800 text-base font-semibold  no-underline shadow-none" href="#">Xem thêm<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <div className="bg-white p-4 col-span-2 shadow-lg overflow-hidden">
      {/* Hàng 1: Ảnh */}
            <div className="relative w-full h-48">
              <Image
                src="/image/money_14959306.png" // Đường dẫn ảnh trong thư mục public
                alt="Ảnh minh họa"
                fill
            ...
            <div className="bg-white p-4 shadow-lg">Div 3</div>
            <div className="bg-white p-4 shadow-lg">Div 4</div>
            </div>
        </div> 
      </div>
    </main>
