    ...
    <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory md:hidden">
      {[
        ...
        >
          ...
          <button className="px-6 py-2 bg-white mt-auto text-[#01274B] rounded-lg shadow-md transform transition-all duration-300 hover:bg-[#01274B] hover:text-white hover:scale-105 hover:shadow-xl">
            <a href="#">Xem chi tiết</a>
          </button>
        </div>
      ))}
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:px-6">
    {/* Box 1 */}
      ...
      <table className="w-full border-collapse text-sm md:text-base">
        ...
        <tbody>
          <tr className="text-center hover:bg-blue-100 text-[#01274B]">
    ...
    {/* Box 2 */}
      <div className="bg-white flex flex-col p-6 shadow-lg rounded-lg transform transition duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl">
      <h3 className="text-xl font-semibold mb-4 text-[#01274B]">Lãi suất cho vay</h3>
      <table className="w-full border-collapse text-sm md:text-base">
        <thead>
          <tr className="bg-[#01274B] text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-12">
            ...
            <a
            className="inline-flex items-center gap-1 text-blue-800 text-base font-semibold no-underline group"
            href="#"
            >
            Xem thêm
            <svg
