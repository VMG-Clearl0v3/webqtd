     ...
     <footer>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm ">
        ...
        <div>
          ...
          <p>37 Ngô Thì Nhậm, P.Trung Sơn, T.Ninh Bình</p>
          <div className="flex items-center pl-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" width="10"
              height="10">
