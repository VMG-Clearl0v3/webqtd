...
//         </svg>
//         <h1 className="text-xl font-semibold">Điều kiện vay vốn</h1>
//         </div>
...
//           <path d="M12.971 1.816A5.23 5.23 0 0 1 14.25 5.25v1.875c0 .207.168.375.375.375H16.5a5.23 5.23 0 0 1 3.434 1.279 9.768 9.768 0 0 0-6.963-6.963Z" />
//         </svg>
//         <h1 className="text-xl font-semibold">Tính năng</h1>
//         </div>
//         <ul className="md:text-lg sm:text-md list-disc pl-6 space-y-2 text-justify">
...
//           <path d="M12.971 1.816A5.23 5.23 0 0 1 14.25 5.25v1.875c0 .207.168.375.375.375H16.5a5.23 5.23 0 0 1 3.434 1.279 9.768 9.768 0 0 0-6.963-6.963Z" />
//         </svg>
//         <h1 className="text-xl font-semibold">Hồ sơ thủ tục</h1>
//         </div>
//         <ul className="md:text-lg sm:text-md list-disc pl-6 space-y-2 text-justify">
...
// }) {
//   // ✅ phải await trước khi destructure
//   const { slug } = await params;
//   const product = await getProductBySlug(slug);
